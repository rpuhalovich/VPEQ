...
public:
    ...
    static FUnknown* createInstance(void* context) {
        return (IAudioProcessor*)new VST3Plugin();
    }
...
public:
    VST3UpdateHandler(VSTGUI::ControlUpdateReceiver* _receiver, VST3Plugin* _editController) {
        receiver = _receiver;
        editController = _editController;
    }
    ~VST3UpdateHandler() {}
...
public:
    ...
    virtual tresult PLUGIN_API onFocus(TBool /*state*/)  override {
        return kResultFalse;
    }
    ...
    virtual tresult PLUGIN_API canResize()  override {
        return kResultFalse /*kResultTrue*/;
    }

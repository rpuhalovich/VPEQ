...
public:
    ...
    */
    int32_t getChannelInputFormat(uint32_t ioConfigIndex) {
        return pluginDescriptor.supportedIOCombinations[ioConfigIndex].inputChannelFormat;
    }
    ...
    */
    int32_t getChannelOutputFormat(uint32_t ioConfigIndex) {
        return pluginDescriptor.supportedIOCombinations[ioConfigIndex].outputChannelFormat;
    }
    ...
    */
    bool hasSidechain() {
        return pluginDescriptor.hasSidechain;
    }
    ...
    */
    bool wantsMIDI() {
        return pluginDescriptor.wantsMIDI;
    }
    ...
    */
    bool hasCustomGUI() {
        return pluginDescriptor.hasCustomGUI;
    }
    ...
    */
    double getLatencyInSamples() {
        return pluginDescriptor.latencyInSamples;
    }
    ...
    */
    double getTailTimeInMSec() {
        return pluginDescriptor.tailTimeInMSec;
    }
    ...
    */
    bool wantsInfiniteTailVST3() {
        return pluginDescriptor.infiniteTailVST3;
    }
    ...
    */
    const char* getPluginName() {
        return pluginDescriptor.pluginName.c_str();
    }
    ...
    */
    const char* getShortPluginName() {
        return pluginDescriptor.shortPluginName.c_str();
    }
    ...
    */
    const char* getVendorName() {
        return pluginDescriptor.vendorName.c_str();
    }
    ...
    */
    uint32_t getPluginType() {
        return pluginDescriptor.pluginTypeCode;
    }
    ...
    */
    double getSampleRate() {
        return audioProcDescriptor.sampleRate;
    }
    ...
    */
    int getFourCharCode() {
        return apiSpecificInfo.fourCharCode;
    }
    ...
    */
    const uint32_t getAAXManufacturerID() {
        return apiSpecificInfo.aaxManufacturerID;
    }
    ...
    */
    const uint32_t getAAXProductID() {
        return apiSpecificInfo.aaxProductID;
    }
    ...
    */
    const char* getAAXBundleID() {
        return apiSpecificInfo.aaxBundleID.c_str();
    }
    ...
    */
    const char* getAAXEffectID() {
        return apiSpecificInfo.aaxEffectID.c_str();
    }
    ...
    */
    uint32_t getAAXPluginCategory() {
        return apiSpecificInfo.aaxPluginCategoryCode;
    }
    ...
    */
    const char* getVST3_FUID() {
        return apiSpecificInfo.vst3FUID.c_str();
    }
    ...
    */
    bool wantsVST3SampleAccurateAutomation() {
        return apiSpecificInfo.enableVST3SampleAccurateAutomation;
    }
    ...
    */
    uint32_t getVST3SampleAccuracyGranularity() {
        return apiSpecificInfo.vst3SampleAccurateGranularity;
    }
    ...
    */
    const char* getVST3BundleID() {
        return apiSpecificInfo.vst3BundleID.c_str();
    }
    ...
    */
    const char* getAUBundleID() {
        return apiSpecificInfo.auBundleID.c_str();
    }
    ...
    */
    const char* getAUBundleName() {
        return apiSpecificInfo.auBundleName.c_str();
    }

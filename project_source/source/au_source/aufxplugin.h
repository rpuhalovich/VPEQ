// -----------------------------------------------------------------------------
//    ASPiK AU Shell File:  aufxplugin.h
//
/**
    \file   aufxplugin.h
    \author Will Pirkle
    \date   17-September-2018
    \brief  interface file for the AUFXPlugin which is the ASPiK AU Shell object
...
protected:
    AUFXPlugin* auInstance = nullptr; ///< our plugin object for setAUParameterChangeEvent()
};
...
protected:
    ...
    AUFXPlugin* auInstance = nullptr; ///< the AU plugin (NOTE this is not base-class)
